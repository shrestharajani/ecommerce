    ...
    <>
      ...
      {loading ?
        ...
        <div className="product">
          <>
            <Link to='/feature-product'><h2 className="main-color">Featured Products (View all)</h2></Link>
            <Row>
          ...
          {HomeContent.map((items, index) => (
            <div key={index}>
              <Link to={items.link}><h2 style={{ marginTop: '4rem' }} className="main-color">{items.title} {''} (View all)</h2></Link>
